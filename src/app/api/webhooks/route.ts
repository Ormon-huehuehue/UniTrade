...
import { UserProps, createUser } from '@/lib/users'
import { User } from '@prisma/client'
import { UserInt } from '@/lib/users'
...
export async function POST(req: Request) {
  ...
  if (eventType === 'user.created') {
    ...
    // const {first_name, id, image_url, last_name} = evt.data;
    // const {phone_number} = evt.data.phone_numbers
